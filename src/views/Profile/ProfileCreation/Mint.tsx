...
import { useCake, useBunnyFactory } from 'hooks/useContract3'
...
const Mint: React.FC = () => {
  ...
  return (
    <>
      ...
      <Text as="p" mb="24px">
        {t('You can change your profile pic later if you get another approved HubDAO Collectible.')}
      </Text>
      <Card mb="24px">
        <CardBody>
          ...
          {!hasMinimumCakeRequired && (
            <Text color="failure" mb="16px">
              {t('A minimum of %num% HD is required', { num: MINT_COST })}
            </Text>
          )}
