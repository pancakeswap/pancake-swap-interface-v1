...
import { Svg, SvgProps, Text, Flex } from '@pancakeswap-libs/uikit'

export const PinkBall: React.FC<{ width?: string; height?: string } & SvgProps> = (props) => {
  return (
...
export const LilacBall: React.FC<{ width?: string; height?: string } & SvgProps> = (props) => {
  return (
    <Svg viewBox="0 0 32 32" {...props}>
...
export const TealBall: React.FC<{ width?: string; height?: string } & SvgProps> = (props) => {
  return (
    <Svg viewBox="0 0 32 32" {...props}>
...
export const AquaBall: React.FC<{ width?: string; height?: string } & SvgProps> = (props) => {
  return (
    <Svg viewBox="0 0 32 32" {...props}>
...
export const GreenBall: React.FC<{ width?: string; height?: string } & SvgProps> = (props) => {
  return (
    <Svg viewBox="0 0 32 32" {...props}>
...
export const YellowBall: React.FC<{ width?: string; height?: string } & SvgProps> = (props) => {
  return (
    <Svg viewBox="0 0 32 32" {...props}>
