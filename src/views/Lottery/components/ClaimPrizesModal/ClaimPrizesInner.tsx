...
import { Flex, Button, Text, AutoRenewIcon, PresentWonIcon } from '@pancakeswap-libs/uikit'
...
import { useLotteryV2Contract } from 'hooks/useContract3'
  ...
  const handleClaim = async () => {
    ...
    try {
      ...
      if (receipt.status) {
        toastSuccess(
          t('Prizes Collected!'),
          t('Your HD prizes for round %lotteryId% have been sent to your wallet', { lotteryId })
        )
        setPendingTx(false)
