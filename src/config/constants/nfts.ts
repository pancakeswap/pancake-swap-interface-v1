...
export const nftSources: NftSource = {
  ...
  [NftType.MIXIE]: {
    address: {
      128: '0xa251b5EAa9E67F2Bc8b33F33e20E91552Bf85566',
      256: '',
    },
    identifierKey: 'image',
  },
...
const Nfts: Nft[] = [
  ...
  {
    name: 'Churro',
    description: "Don't let that dopey smile deceive you... Churro's a master HD chef!",
    images: {
      lg: 'churro-lg.png',
      md: 'churro-md.png',
      sm: 'churro-sm.png',
  ...
  {
    name: 'Dollop',
    description: "Nommm... Oh hi, I'm just meditating on the meaning of HD.",
    images: {
      lg: 'dollop-lg.png',
      md: 'dollop-md.png',
      sm: 'dollop-sm.png',
  ...
  {
    name: 'Twinkle',
    description: "Three guesses what's put that twinkle in those eyes! (Hint: it's HD)",
    images: {
      lg: 'twinkle-lg.png',
      md: 'twinkle-md.png',
      sm: 'twinkle-sm.png',
