      ...
      <AutoColumn gap="12px">
        ...
        {showMore && (
          <AutoColumn gap="8px">
            <FixedHeightRow>
              <RowFixed>
                <Text>{TranslateString(1, "Pooled")} {currency0.symbol}:</Text>
              </RowFixed>
              {token0Deposited ? (
                <RowFixed>
            ...
            <FixedHeightRow>
              <RowFixed>
                <Text>{TranslateString(1, "Pooled")} {currency1.symbol}:</Text>
              </RowFixed>
              {token1Deposited ? (
                <RowFixed>
            ...
            <FixedHeightRow>
              <Text>{TranslateString(1, "Your pool share")}:</Text>
